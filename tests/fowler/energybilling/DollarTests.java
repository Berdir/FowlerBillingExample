...
public class DollarTests {
	...
	public void testDollars() {
		...
		assertTrue("Dollars plus",
				(new Dollars(0.0).plus(d1)).getAmount() == 5.0);
		assertTrue("Dollars minus",
				(new Dollars(0.0).minus(d1)).getAmount() == -5.0);
		assertTrue("Dollars times",
				(new Dollars(0.0).times(1.0)).getAmount() == 0.0);
