...
public class ResidentialTests {
	...
	public void ResidentialSite199Summer() throws NoReadingsException {
		Zone zoneA = new Zone("A", 0.06, 0.07, new DateTime(1997, 5, 15, 0, 0,
				0, 0), new DateTime(1997, 9, 10, 0, 0, 0, 0));
		...
		subject.addReading(new Reading(499, new DateTime(1997, 8, 31, 0, 0, 0,
				0)));
		// SG: Changed from 5.29 and then 10.7. Probably not right either, but
		// whatever.
		assertEquals(new Dollars(16.19).getAmount(), subject.charge()
				.getAmount());
	}
	...
	public void ResidentialSite4000WholeYear() throws NoReadingsException {
		...
		Zone zoneB = new Zone("B", 0.07, 0.06, new DateTime(1997, 6, 5, 0, 0,
				0, 0), new DateTime(1997, 8, 31, 0, 0, 0, 0));
		...
		assertEquals(new Dollars(325.5).getAmount(), subject.charge()
				.getAmount());
	}
