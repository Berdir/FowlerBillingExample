...
public class DisabilityTests {
	...
	public static void setUp() throws Exception {
		zoneA = new Zone("A", 0.06, 0.07,
				new DateTime(1997, 5, 15, 0, 0, 0, 0), new DateTime(1997, 9,
						10, 0, 0, 0, 0));
		zoneB = new Zone("B", 0.07, 0.06, new DateTime(1997, 6, 5, 0, 0, 0, 0),
				new DateTime(1997, 8, 31, 0, 0, 0, 0));
	}
	...
	public void DisabilitySite199Summer() {
		...
		subject.addReading(new Reading(300,
				new DateTime(1997, 6, 5, 0, 0, 0, 0)));
	...
	public void DisabilitySite199WholeYear() {
		TimedSite subject = new DisabilitySite(zoneA);
		subject.addReading(new Reading(20000, new DateTime(1997, 1, 1, 0, 0, 0,
				0)));
		subject.addReading(new Reading(20199, new DateTime(1997, 12, 31, 0, 0,
				0, 0)));
	...
	public void DisabilitySite4000WholeYear() {
		...
		assertEquals(new Dollars(94.86).getAmount(), subject.charge()
				.getAmount());
	}
}
