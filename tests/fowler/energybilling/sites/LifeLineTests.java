...
public class LifeLineTests {
	...
	public void LifeLineSite100() {
		LifelineSite subject = new LifelineSite();
		subject.addReading(new Reading(10, new DateTime(1997, 1, 1, 0, 0, 0, 0)));
		subject.addReading(new Reading(110,
				new DateTime(1997, 1, 2, 0, 0, 0, 0)));
		// System.out.println("100Charge is: "+subject.charge().getAmount());
		assertEquals(new Dollars(1.83).getAmount(), subject.charge()
				.getAmount());
	}
	...
	public void LifeLineSite101() {
		...
		subject.addReading(new Reading(1000, new DateTime(1997, 1, 1, 0, 0, 0,
				0)));
		subject.addReading(new Reading(1101, new DateTime(1997, 2, 1, 0, 0, 0,
				0)));
		// System.out.println("101Charge is: "+subject.charge().getAmount());
		assertEquals(new Dollars(1.85).getAmount(), subject.charge()
				.getAmount());
	}
	...
	public void LifeLineSite200() {
		...
		subject.addReading(new Reading(200,
	...
	public void LifeLineSite201() {
		...
		subject.addReading(new Reading(251,
				new DateTime(1997, 2, 1, 0, 0, 0, 0)));
	...
	public void LifeLineSiteMax() {
		LifelineSite subject = new LifelineSite();
		subject.addReading(new Reading(0, new DateTime(1997, 1, 1, 0, 0, 0, 0)));
		subject.addReading(new Reading(Integer.MAX_VALUE, new DateTime(1997, 2,
				1, 0, 0, 0, 0)));
	...
	/**
	 * Test that there is no exception thrown when charge() is called without
	 * any Readings.
	 */
	@Test
